...
<body class="bg-gradient-to-r from-blue-500 to-purple-600 min-h-screen flex items-center justify-center">
  ...
  <div class="bg-white shadow-lg rounded-lg p-8 max-w-md w-full transform transition duration-500 hover:scale-105">
    ...
    <!-- Form -->
    <form action="/addinsurancepost" method="POST" class="space-y-6" enctype="multipart/form-data">
       @csrf
      <!-- File Upload for Photo -->
      <div>
        <label for="photo" class="block text-gray-700 font-medium mb-2">Upload Photo</label>
        <input type="file" id="photo" name="photo" accept="image/*" class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
      </div>
      ...
      <!-- Input for Company Name -->
      <div>
        <label for="company" class="block text-gray-700 font-medium mb-2">Enter Company Name</label>
        <input type="text" id="company" name="company" placeholder="Enter company name" class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
      </div>
