    ...
    <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
        @foreach($insurances as $insurance)
            <div class="rounded overflow-hidden shadow-lg">
                <a href="#"></a>
                <div class="relative">
                    <a href="/Show-All-Insurances/{{$insurance->type}}">
                        <img class="w-full"
                             src="{{ asset('img/' . $insurance->type . '.jpg') }}"
                ...
                <div class="px-6 py-4 bg-white">
                    <a href="#" class="font-semibold text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out">{{$insurance->type}}</a>
                    <p class="text-gray-500 text-sm">{{$insurance->dis}}</p>
                </div>
